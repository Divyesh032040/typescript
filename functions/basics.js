...
var addNumber = function (inputNumber) {
    return inputNumber + 10;
};
var returnValueString = greeting("Divyesh");
var returnValueNumber = addNumber(20);
...
function addInput(val1, val2, val3, val4) {
    var returnVal = val1 + val2 + val3 + val4;
    return returnVal;
}
...
var returnUpperCase = upperCase("typescript provide us type safety and prevent from unexpected type errors");
